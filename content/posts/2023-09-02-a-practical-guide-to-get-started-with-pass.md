...
slug: a-practical-guide-to-get-started-with-pass
aliases:
- /a-practical-guide-to-get-started-with-pass.html
---
# 1.  Introduction
...
# 2.  Why a (dedicated) password manager
...
## 4.1  Coming up with a good pass phrase
...
## 4.3  Taking back up of the GPG key
...
# 6.  Storing and retrieving a password in Pass
...
# 8.  A common problem and the solution
